...
public class NQJTranspiler {
    ...
    public String print() {
        String prefix = "import java.lang.System; class " + globalClassName + " { static int printInt(int value) { System.out.println(value); return value; } public static void main(String[] args) { new "
